// Ported from RetroArch slang frontend (gfx/drivers_shader/slang_reflection.h/.hpp)
...
template <typename P>
static bool slang_set_unique_map(std::unordered_map<std::string, P> &m, const std::string &name, const P &p) {
